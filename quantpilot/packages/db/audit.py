...
AUDIT_EVENT_ACTIONS = {
    ...
    "level_1_2_mock_execution_started",
    "level_1_2_mock_execution_completed",
    "level_1_2_mock_order_authorized",
    "level_1_2_mock_order_submitted",
    ...
    "paper_dispatch_prepare_failed",
    "paper_submission_outcome_unknown",
    "paper_order_rejected",
    "paper_order_recovered",
    ...
    "approval_ticket_duplicate_blocked",
