...
& $runtimePython -m pip install 'fastapi==0.133.1' 'starlette==1.0.1' pydantic pyyaml uvicorn httpx pytest 'exchange-calendars==4.13.2' 'websockets==15.0.1' 'cryptography==50.0.1'
