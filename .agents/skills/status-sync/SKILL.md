...
- 웹은 2026-09-10 제거했다. 과거 프런트 검증 증거는 보존하고 현재 npm 검사를 요구하지 않는다.
- API: `openapi.json 바이트 단위 동기화 (N paths)` — [[openapi-sync]] 스킬 절차. 삭제된 d.ts는 재생성하지 않는다.
...
<!-- aorch-generated: skill:status-sync; mode=native; edit .agents/aorch/definitions.json -->
