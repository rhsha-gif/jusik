...
| `QP-HO-010` | Codex GPT-5.6 | Claude Fable 5 | `QP-HO-000` | same | `docs/roadmap_continuation_handoff.md`, this workboard | in_progress | self-contained roadmap/status/commands/risks; exact full hashes; accepted vs integrated separated | draft present |
| `QP-HO-020` | Claude Code `claude-fable-5` | Codex mission lead | `QP-HO-010` | `주식트레이더-claude-roadmap-handoff-20260714` / `claude/qp-roadmap-handoff-20260714` | `docs/roadmap_continuation_handoff_claude_review.md` only | ready | substantive P0/P1/P2 audit, exact source commit/hash binding, direct commit | pending |
| `QP-HO-030` | Codex mission lead | independent Claude artifact | `QP-HO-020` | Codex worktree then clean main integration | exact three handoff docs only | proposed | counterpart findings resolved, link/hash/diff checks, docs-only commit and main integration, user status preserved | pending |
...
acceptance_met: pending counterpart artifact and final docs-only audit
...
|---|---|---|---|---:|---:|---:|---:|---|---|---:|
| `QP-HO-010` | repository-grounded handoff | Codex GPT-5.6 | pending | 0 | 0 | 0 | 0 | exact facts, links, diff, counterpart review | in progress | 0 |
| `QP-HO-020` | independent documentation audit | Claude Fable 5 | pending | 0 | 0 | 0 | 0 | one-file artifact + direct commit | pending | 0 |

- Routing decision quality: pending final artifact.
- Capability scorecard update: documentation-only one-off; update only after mission acceptance.
