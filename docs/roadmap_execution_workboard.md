...
| `QP-RISK-RES-V1` | GPT-5 Codex lead | Claude Code independent audit | `QP-RM-00`, `QP-RM-00A` | `주식트레이더-risk-reservation-v1` / `codex/qp-risk-reservation-v1-core` | risk reservation model/store/integration/tests/report | review | Schema v10 atomic cash/sell-quantity/gross-exposure reservation passes concurrency, crash, migration, full-suite, and smoke gates; integration awaits Claude audit retry. | `884 passed, 2 skipped`; smoke mock/live=false; internal audit P0/P1=0; Claude `429` retry pending |
